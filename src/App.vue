<!--<template>
 <div id="app">
  ...
  Следователно ще откриете, че не е необходимо да използвате router-linkкомпонента. 
  Редица компоненти на Vuetify могат да действат като маршрутни връзки, като просто 
  посочат toо  пората.
  -->
 <template>
  <v-app>
